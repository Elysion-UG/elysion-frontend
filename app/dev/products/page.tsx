  ...
  return (
    <Card className="mb-4">
      ...
      <CardContent className="space-y-3">
        ...
        {response !== null && (
          <pre className="mt-2 max-h-60 overflow-auto whitespace-pre-wrap rounded border border-slate-200 bg-slate-50 p-3 text-xs">
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        <h1 className="mb-1 text-2xl font-bold text-slate-800">Products API Test</h1>
        <p className="mb-8 text-sm text-slate-500">
          Product CRUD, status, images, variants, certificates
        </p>

        {/* ── Products CRUD ─────────────────────────────────── */}
        <h2 className="mb-3 mt-2 text-base font-semibold text-slate-700">Products CRUD</h2>
        ...
        >
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              <Label className="text-xs">categoryId</Label>
              <Input
            ...
            <div>
              <Label className="text-xs">basePrice (EUR, e.g. 29.99)</Label>
              <Input
                type="number"
                value={createPrice}
            ...
            <div>
              <Label className="text-xs">taxRateBps (e.g. 1900 for 19%)</Label>
              <Input
                type="number"
                value={createTaxRate}
        ...
        <EndpointCard
          ...
          onExecute={() => {
            ...
            return apiRequest(`/api/v1/products/${updateId}`, {
              method: "PATCH",
        ...
        >
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              <Label className="text-xs">basePrice EUR (optional)</Label>
              <Input
                type="number"
                value={updatePrice}
        ...
        {/* ── Product Images ─────────────────────────────────── */}
        <h2 className="mb-3 mt-6 text-base font-semibold text-slate-700">Product Images</h2>
        ...
        >
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label className="text-xs">id (product id)</Label>
              <Input
                value={imgUploadId}
                onChange={(e) => setImgUploadId(e.target.value)}
                placeholder="UUID"
                className="h-8 text-xs"
              />
            </div>
            <div>
              ...
              <input
                ...
                type="file"
                accept="image/*"
                className="h-8 w-full rounded border border-slate-200 bg-white px-2 py-1 text-xs"
              />
            </div>
          </div>
        </EndpointCard>
        ...
        <EndpointCard
          ...
          onExecute={() =>
            apiRequest(`/api/v1/products/${delImgProductId}/images/${delImageId}`, {
              method: "DELETE",
            })
          }
        >
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <Input
                value={delImgProductId}
                onChange={(e) => setDelImgProductId(e.target.value)}
                placeholder="UUID"
                className="h-8 text-xs"
              />
            </div>
            <div>
              <Label className="text-xs">imageId</Label>
              <Input
                value={delImageId}
                onChange={(e) => setDelImageId(e.target.value)}
                placeholder="UUID"
                className="h-8 text-xs"
              />
            </div>
        ...
        <EndpointCard
          ...
          onExecute={() => {
            let imageIds: string[] = []
            try {
              imageIds = JSON.parse(reorderImageIds)
            } catch {
              /* ignore */
            }
        ...
        >
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="col-span-2">
              <Label className="text-xs">imageIds (JSON array of UUIDs)</Label>
              <Textarea
                value={reorderImageIds}
                onChange={(e) => setReorderImageIds(e.target.value)}
                className="h-16 text-xs"
              />
            </div>
          </div>
        ...
        {/* ── Product Variants ─────────────────────────────────── */}
        <h2 className="mb-3 mt-6 text-base font-semibold text-slate-700">Product Variants</h2>
        ...
        <EndpointCard
          ...
          onExecute={() => {
            ...
            try {
              attributes = JSON.parse(varAttributes)
            } catch {
              /* ignore */
            }
            const body: Record<string, unknown> = {
        ...
        >
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              <Label className="text-xs">priceCents (optional)</Label>
              <Input
                type="number"
                value={varPriceCents}
                onChange={(e) => setVarPriceCents(e.target.value)}
                placeholder="2999"
                className="h-8 text-xs"
              />
            </div>
            ...
            <div className="col-span-2">
              <Label className="text-xs">attributes (JSON object)</Label>
              <Textarea
                value={varAttributes}
                onChange={(e) => setVarAttributes(e.target.value)}
                className="h-16 text-xs"
              />
            </div>
          </div>
        ...
        >
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label className="text-xs">productId</Label>
              <Input
                value={updVarProductId}
                onChange={(e) => setUpdVarProductId(e.target.value)}
                placeholder="UUID"
                className="h-8 text-xs"
              />
            </div>
            <div>
              <Label className="text-xs">variantId</Label>
              <Input
                value={updVarId}
                onChange={(e) => setUpdVarId(e.target.value)}
                placeholder="UUID"
                className="h-8 text-xs"
              />
            </div>
            <div>
              ...
              <Input
                value={updVarSku}
                onChange={(e) => setUpdVarSku(e.target.value)}
                className="h-8 text-xs"
              />
            </div>
            <div>
              ...
              <Input
                value={updVarName}
                onChange={(e) => setUpdVarName(e.target.value)}
                className="h-8 text-xs"
              />
            </div>
            <div>
              <Label className="text-xs">priceCents</Label>
              <Input
                type="number"
                value={updVarPriceCents}
                onChange={(e) => setUpdVarPriceCents(e.target.value)}
                className="h-8 text-xs"
              />
            </div>
            <div>
              ...
              <Input
                type="number"
                value={updVarStock}
                onChange={(e) => setUpdVarStock(e.target.value)}
                className="h-8 text-xs"
              />
            </div>
          </div>
        ...
        <EndpointCard
          ...
          onExecute={() =>
            apiRequest(`/api/v1/products/${delVarProductId}/variants/${delVarId}`, {
              method: "DELETE",
            })
          }
        >
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label className="text-xs">productId</Label>
              <Input
                value={delVarProductId}
                onChange={(e) => setDelVarProductId(e.target.value)}
                placeholder="UUID"
                className="h-8 text-xs"
              />
            </div>
            <div>
              ...
              <Input
                value={delVarId}
                onChange={(e) => setDelVarId(e.target.value)}
                placeholder="UUID"
                className="h-8 text-xs"
              />
            </div>
        ...
        <h2 className="mb-3 mt-6 text-base font-semibold text-slate-700">Product Certificates</h2>

        {/* 12. List certificates */}
        <EndpointCard
          method="GET"
          path="/api/v1/products/{id}/certificates"
          auth="PUBLIC"
