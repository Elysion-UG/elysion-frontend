      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          {Array.from({ length: 3 }).map((_, i) => (
            ...
            >
              <div className="h-20 w-20 flex-shrink-0 animate-pulse rounded-lg bg-sage-50" />
              <div className="min-w-0 flex-1 space-y-2">
                <div className="h-4 w-2/3 animate-pulse rounded bg-stone-200" />
                <div className="h-3 w-1/3 animate-pulse rounded bg-stone-100" />
                <div className="mt-3 h-7 w-28 animate-pulse rounded-full bg-stone-100" />
              </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 rounded-xl border border-stone-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 h-11 w-full animate-pulse rounded-xl bg-sage-100" />
          </div>
        </div>
      </div>
    </div>
