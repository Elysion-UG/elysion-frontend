  ...
  return (
    <div className="mx-auto max-w-3xl" data-testid="order-detail-skeleton" aria-busy="true">
        ...
        <div className="space-y-3">
          {Array.from({ length: 2 }).map((_, i) => (
            <div key={i} className="flex gap-3">
              <div className="h-14 w-14 animate-pulse rounded-lg bg-sage-50" />
      ...
      <div className="rounded-xl border border-stone-200 bg-white p-6 shadow-sm">
        <div className="mb-4 h-4 w-36 animate-pulse rounded bg-stone-200" />
